...
class HitObject(Map):
    def __init__(self, x, y, r, hitWindow300, hitWindow100, hitWindow50, hitTime, type, objectParams):
        super().init(r, hitWindow300, hitWindow100, hitWindow50)
        self.x = x
        self.y = y
...
def appStarted(app):
    ...
    pygame.mixer.pre_init(44100, -16, 1, 512) # Used to remove sound delay, especially with histounds, taken from https://stackoverflow.com/questions/18273722/pygame-sound-delay 
    pygame.mixer.init()
...
def approachIncrements(app, canvas, hitObject):
    time = hitObject
